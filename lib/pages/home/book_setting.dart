...
import 'package:qb_flutter_reader/blocs/setting_bloc.dart';
import 'package:qb_flutter_reader/common/global_stage.dart';
import 'package:qb_flutter_reader/common/redux/theme_redux.dart';
import 'package:qb_flutter_reader/common/utils/constans.dart';
import 'package:qb_flutter_reader/common/utils/settings.dart';
import 'package:qb_flutter_reader/plugins/colorpicker/material_color_picker.dart';
import 'package:qb_flutter_reader/widgets/dialog_base.dart';
...
class _BookSettingPageState extends State<BookSettingPage> {
  ...
  List<String> _contents = ["主题", "语言", "清除缓存"];
